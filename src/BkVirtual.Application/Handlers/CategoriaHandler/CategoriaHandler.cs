...
namespace BkVirtual.Application.Handlers.CategoriaHandler;
    ...
    IRequestHandler<EditarCategoriaRequest, BaseResponse>
{
    ...
    public async Task<BaseResponse> Handle(ListarCategoriaRequest categoriaRequest, CancellationToken cancellationToken)
    {
        ...
        var categorias =
            await _paginacaoCategorias.CriarAsync(_categoriaRepository.BuscarTodas(), categoriaRequest.Indice,
